  ...
  const schemaMarkup = {
    ...
    itemListElement: jewelers.map((j, i: number) => ({
      ...
      item: {
        ...
        ...(j.type ? { description: `Jubiler — ${j.type === "studio" ? "Studio" : "Sklep"}` } : {}),
      },
    })),
  };
    ...
    <>
      ...
      <div>
        ...
        <p className="text-gray-600 mb-2">
          ...
          Przeglądaj profile, porównuj usługi i ceny, znajdź jubilera w swoim mieście.
        </p>
